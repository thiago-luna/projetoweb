...
<html>
<head>
<title>Exibe os dados da pessoa</title>
<c:import url="../componentes/cabecalho.jsp" />

<main>
	<div class="container">
		<div class="card border-light mb-3">
			<div class="card-header">Exibe os dados da pessoa</div>
			<!-- Table -->
			<div class="card-body">
				<div class="table-responsive">
					<table
						...
						<tr>
							<th>Nome</th>
							<td style="font-weight: bold; color:blue ;">${pessoa.nome}</td>
						</tr>
						<tr>
							<th>Matricula</th>
							<td style="font-weight: bold; color: ;">${pessoa.matricula}</td>
						</tr>
						<tr>
							<th>Email</th>
							<td style="font-weight: bold; color: ;">${pessoa.email}</td>
						</tr>
						<tr>
							<th>Telefone</th>
							<td style="font-weight: bold; color: ;">${pessoa.telefone}</td>
						</tr>
						<tr>
							<th>Tipo</th>
							<td style="font-weight: bold; color: ;">${pessoa.tipo}</td>
						</tr>
					</table>
				</div>
			</div>
		...
		<div align="center">
			...
			<a href="<c:url value="/pessoa/novo" />"
				...
				Cadastrar</a>
			<!-- Editar -->
			<a href="<c:url value="/pessoa/edita?id=${pessoa.id}" />"
				class="btn btn-warning btn-lg"><i class="bi bi-pencil-square"></i>
				Editar </a>
			<!-- Excluir -->
			<button type="button" class="btn btn-danger btn-lg"
				data-bs-toggle="modal" data-bs-target="#modal${pessoa.id}">
