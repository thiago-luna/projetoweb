...
<html>
<head>
<title>Exibe os dados do produto</title>
<c:import url="../componentes/cabecalho.jsp" />

<main>
	<div class="container">
		<div class="card border-light mb-3">
			<div class="card-header">Exibe os dados do produto</div>
			<!-- Table -->
			<div class="card-body">
				<div class="table-responsive">
					<table
						...
						<tr>
							<th>Nome</th>
							<td style="font-weight: bold; color:blue ;">${produto.nome}</td>
						</tr>
						<tr>
							<th>Tipo</th>
							<td style="font-weight: bold; color: ;">${produto.tipo}</td>
						</tr>
						<tr>
							<th>Quantidade</th>
							<td style="font-weight: bold; color: ;">${produto.quantidade}</td>
						</tr>
						<tr>
							<th>Marca</th>
							<td style="font-weight: bold; color: ;">${produto.marca}</td>
						</tr>
						<tr>
							<th>Valor</th>
							<td style="font-weight: bold; color: ;">${produto.valor}</td>
						</tr>
					</table>
				</div>
			</div>
		...
		<div align="center">
			...
			<a href="<c:url value="/produto/novo" />"
				...
				Cadastrar</a>
			<!-- Editar -->
			<a href="<c:url value="/pessoa/edita?id=${produto.id}" />"
				class="btn btn-warning btn-lg"><i class="bi bi-pencil-square"></i>
				Editar </a>
			<!-- Excluir -->
			<button type="button" class="btn btn-danger btn-lg"
				data-bs-toggle="modal" data-bs-target="#modal${produto.id}">
